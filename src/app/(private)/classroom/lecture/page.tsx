...
export default function LecturePage() {
  ...
  const [selectedLectureTitle, setSelectedLectureTitle] = useState<string>(""); // 강의명 상태
  ...
  const handleReviewSubmit = async () => {
    if (selectedLectureId && reviewData.star > 0 && reviewData.content.trim()) {
      try {
        ...
        setReviewData({ star: 0, content: "" }); // 초기화
        setSelectedLectureId(null); // 초기화
      } catch (error) {
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              className="w-full p-2 border rounded text-black placeholder-gray-400 h-[200px] resize-none" // 수정
